...
// Copyright (c) 2019, GalaxyBitz Project
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x5ef;
...
const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 10000000;
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 100000000;
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 1000000000;
...
const char     CRYPTONOTE_NAME[]                             = "GalaxyBitz";
...
const int      P2P_DEFAULT_PORT                              =  8001;
const int      RPC_DEFAULT_PORT                              =  8002;
...
const char     LATEST_VERSION_URL[]                          = "https://github.com/gbitzdotcom/GalaxyBitz/releases";
const std::string LICENSE_URL                                = "https://github.com/gbitzdotcom/";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x67, 0x61, 0x6c, 0x61, 0x78, 0x79, 0x62, 0x69, 0x74, 0x7a, 0x6e, 0x65, 0x78, 0x77, 0x67, 0x61  }
};

const char* const SEED_NODES[] = {
    "37.44.236.151:8001",  //WørkNØX#0174
    "188.40.181.255:8001", //WørkNØX#0174
	"178.128.7.239:8001",  //CryptKeeper#9649
	"138.68.15.98:8001"    //CryptKeeper#9649
